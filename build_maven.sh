...
MAVEN_OPTS="-Xmx4g -XX:MaxPermSize=512m -XX:ReservedCodeCacheSize=512m" build/mvn -Dhadoop.version=2.2.0 -Phive  -Phive-thriftserver -DskipTests -Dcheckstyle.skip=true -Dlicense.skip=true -Dscalastyle.failOnViolation=false clean package install
